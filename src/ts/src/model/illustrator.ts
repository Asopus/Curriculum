class Illustrator {
    ...
    constructor(canvas: HTMLCanvasElement, snake: Snake, apple: Apple, competences: Array<Competence>)
    {
        this._canvas = canvas;
    ...
    {
        let head: SnakePart = this._snake[this._snake.BodyParts.length - 1];
